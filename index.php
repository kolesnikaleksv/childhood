                ...
                <div class="row">
                  <div class="col-lg-7 offset-1">
                    <h2 
                      class="slider__title"
                      style="<?php
                        $color = get_field('slider_title_color');
                        if($color === 'white') {
                          ?>
                            color: #fff;
                          <?php
                      ...
                      ?>"><?php the_title(); ?></h2>
                     <?php
                        $isBtn = get_field('slider_button');
                        If($isBtn === 'on') {
                          ?>
                            <a href="<?php the_permalink(); ?>" class="button">Дізнатися більше</a>
                          <?php
                        }
                     ?>
                  </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div  class="contacts__feed">
           <?php echo do_shortcode('[contact-form-7 id="db00352" title="Contact form 1"]'); ?>
